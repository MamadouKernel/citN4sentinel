        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordExpiresAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordSetAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnalysedAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CounterEvidence = table.Column<string>(type: "TEXT", nullable: true),
                    EvidenceObservedAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EarliestEntryAt = table.Column<long>(type: "INTEGER", nullable: true),
                    LatestEntryAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanionServiceNames = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    MaintenanceUntil = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    SharedFolder_LastBackupAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutcomeDeclaredAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartWindow = table.Column<long>(type: "INTEGER", nullable: true),
                    EndWindow = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    SecondApprovedAt = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    ContinuityChoiceAt = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    PreflightAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recommendation = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    FirstOccurredAt = table.Column<long>(type: "INTEGER", nullable: false),
                    LastOccurredAt = table.Column<long>(type: "INTEGER", nullable: false),
                    OccurrenceCount = table.Column<int>(type: "INTEGER", nullable: false),
                    ResolvedAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntegratedAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldestFileAt = table.Column<long>(type: "INTEGER", nullable: true),
                    NewestFileAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutomaticRetry = table.Column<bool>(type: "INTEGER", nullable: false),
                    RetryDelaySeconds = table.Column<int>(type: "INTEGER", nullable: false),
                    RetryNotBeforeAt = table.Column<long>(type: "INTEGER", nullable: true),
                    SkippedBy = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    SkipReason = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    SkipCoApprovedBy = table.Column<string>(type: "TEXT", nullable: true),
                    SkipCoApprovedAt = table.Column<long>(type: "INTEGER", nullable: true),
